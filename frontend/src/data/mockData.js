...
export const tours = [
  { id: "gokarna-escape", title: "Gokarna Coastal Escape", destination: "Gokarna, Karnataka", duration: "3 Days / 2 Nights", price: 6999, rating: 4.8, image: destinations[0].image, category: "Beach", places: ["Om Beach", "Kudle Beach", "Yana Caves"], description: "A laid-back coastal journey combining beaches, sunsets and local culture.", dates: ["2026-09-19", "2026-10-03"], included: ["Hotel stay", "Local sightseeing", "Breakfast"], excluded: ["Personal expenses", "Adventure activities"] },
  ...
  ,{ id: "jogfalls-view", title: "Jog Falls Getaway", destination: "Jog Falls, Karnataka", duration: "1 Day", price: 2499, rating: 4.8, image: "/images/jogfalls.jpg", category: "Nature", places: ["Viewpoints", "Local trails"], description: "Short trip to witness the spectacular waterfall.", dates: ["2026-09-29", "2026-10-13"], included: ["Transport"], excluded: ["Food", "Personal expenses"] }
  ...
  ,{ id: "mangalore-coast", title: "Mangalore Coastal Taste & Sights", destination: "Mangalore, Karnataka", duration: "2 Days / 1 Night", price: 5999, rating: 4.5, image: "/images/mangaluru.jpg", category: "Coastal", places: ["Panambur Beach", "St. Aloysius Chapel"], description: "Enjoy beaches and local cuisine in Mangalore.", dates: ["2026-09-30", "2026-10-14"], included: ["Stay", "Breakfast"], excluded: ["Food", "Personal expenses"] }

  ,{ id: "udupi-temple-coast", title: "Udupi Temple & Backwaters", destination: "Udupi, Karnataka", duration: "1 Day", price: 2799, rating: 4.6, image: "/images/udupi.jpg", category: "Cultural", places: ["Sri Krishna Temple", "Malpe Beach"], description: "A short cultural trip including a famous temple visit.", dates: ["2026-09-25", "2026-10-09"], included: ["Transport"], excluded: ["Food", "Personal expenses"] }
];
