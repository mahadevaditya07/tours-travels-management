...
export default function TourDetails() {
  ...
  const dates = Array.isArray(tour.dates) && tour.dates.length ? tour.dates : (Array.isArray(tour.availableDates) && tour.availableDates.length ? tour.availableDates : ["2026-09-15", "2026-10-01"]);
