...
const seedTours = async () => {
  try {
    const tourItems = [
      ...
      { id: "jogfalls-view", title: "Jog Falls Getaway", destination: "Jog Falls, Karnataka", duration: "1 Day", price: 2499, pricePerPerson: 2499, rating: 4.8, image: "/images/jogfalls.jpg", category: "Nature", places: ["Viewpoints", "Local trails"], description: "Short trip to witness the spectacular waterfall.", dates: ["2026-09-29", "2026-10-13"], included: ["Transport"], excluded: ["Food", "Personal expenses"] },
      ...
      { id: "mangalore-coast", title: "Mangalore Coastal Taste & Sights", destination: "Mangalore, Karnataka", duration: "2 Days / 1 Night", price: 5999, pricePerPerson: 5999, rating: 4.5, image: "/images/mangaluru.jpg", category: "Coastal", places: ["Panambur Beach", "St. Aloysius Chapel"], description: "Enjoy beaches and local cuisine in Mangalore.", dates: ["2026-09-30", "2026-10-14"], included: ["Stay", "Breakfast"], excluded: ["Food", "Personal expenses"] },
      { id: "udupi-temple-coast", title: "Udupi Temple & Backwaters", destination: "Udupi, Karnataka", duration: "1 Day", price: 2799, pricePerPerson: 2799, rating: 4.6, image: "/images/udupi.jpg", category: "Cultural", places: ["Sri Krishna Temple", "Malpe Beach"], description: "A short cultural trip including a famous temple visit.", dates: ["2026-09-25", "2026-10-09"], included: ["Transport"], excluded: ["Food", "Personal expenses"] }
    ];
